...
- [ ] Implement UI-004F Calendar and Tasks polish next.
- [ ] Implement UI-004G Automations and Extensions polish after UI-004F.
...
Current estimated work to complete documentation, code commenting, compliance, UI adoption, two-way framework freshness, platform/runtime decision coverage, and reopened UI redesign for initial MVP: 2 remaining UI polish passes (UI-004F–G), plus 1 owner visual proof pass (UI-003E), 1 merge-prep pass, and 1 framework freshness feedback pass to `xi-io.net#239` after proof. ARCH-002 and ARCH-004 remain separate architecture tracks. Product UI code may proceed for UI-004F Calendar and Tasks polish next.
