...
- [x] GMAIL-002A-EXT-004-REPAIR — message-delete index safety + history pagination cursor (`docs/ui/reviews/gmail-002a-ext-004-repair-receipt.md` @ `b2a4b56`); **CATCHUP-REVIEW-002 required before framework backfeed**.
