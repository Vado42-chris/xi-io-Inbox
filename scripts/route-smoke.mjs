...
async function main() {
  ...
  try {
    ...
    if (!/Body not imported|Imported mail|saved snapshot|Read-only body snapshot|Select a conversation|not enabled in this build|Preview only|not live Gmail|saved mail import|snippet only/i.test(readingText)) {
