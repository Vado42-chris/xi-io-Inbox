...
36. SLICE-GMAIL-002A-EXT-002 — local mail index — **complete** (`gmail-002a-ext-002-local-mail-index-receipt.md`)
37. SLICE-GMAIL-002A-EXT-003 — sync status UI + Activity receipts — **next**
38. SLICE-UI-003E owner visual proof — **ready for owner** after UI-013C chrome tweak
39. SLICE-UI-CONVERGE-001 — module skeleton + route-table contract — **ready after owner proof**
