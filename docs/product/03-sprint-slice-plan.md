...
51. SLICE-ARCH-004 formal PASS — **next (owner)** — provisional Tauri decision in `arch-004-runtime-host-decision.md`
52. SLICE-RUNTIME-001 — Gmail runtime provider — **blocked until ARCH-004 formal PASS**

**Agent stop line:** No Mail UI polish, merge prep, or live provider implementation until items 51–52 gate clears.
