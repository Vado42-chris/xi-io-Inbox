...
37. SLICE-UI-003E owner visual proof — **ready for owner** after UI-013C chrome tweak
38. SLICE-UI-CONVERGE-001 — module skeleton + route-table contract — **ready after owner proof**
