...
| GATE-UI-IMPLEMENT-001 | UI implementation | pass for completed static-preview slices; convergence work must follow north-star plan | `docs/ui/reviews/app-peer-review-plan-alignment-2026-06-13.md` |
| GATE-VISUAL-PROOF-001 | Owner/framework visual proof | partial; UI-012D–F and owner UI-003E remain open | `docs/ui/polish/ui-012-visual-polish-governance.md` |
| GATE-DRAFT-WORKBENCH-001 | Draft workbench Tier 1 | partial; UI-007B/C shipped locally, but owner proof and convergence remain open | `docs/ui/reviews/ui-007c-send-event-dry-run-receipt.md` |
...
5. `docs/product/00-product-delivery-governance.md`
6. `docs/product/01-product-requirements-register.md`
7. `docs/product/02-epic-story-backlog.md`
8. `docs/product/03-sprint-slice-plan.md`
9. `docs/product/04-build-readiness-gates.md`
10. `docs/product/05-framework-hydration-checklist.md`
11. `docs/product/06-compliance-validation-index.md`
12. Relevant UI, architecture, security, schema, and framework docs for the active slice.
