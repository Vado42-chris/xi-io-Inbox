...
| GATE-UI-VISUAL-001 | UI visual proof allowed | UI-011A matrix, UI-011B–I repairs, UI-012A–C, NAV-001, peer review | product capability bar mostly met; UI-012D–F and owner UI-003E remain open | `docs/ui/reviews/app-peer-review-plan-alignment-2026-06-13.md` | owner visual sign-off blocked until UI-012F + UI-003E PASS | mark visual proof complete, PR ready-for-review | partial | RISK-002 | after UI-012F + owner UI-003E PASS |
| GATE-DRAFT-WORKBENCH-001 | Draft workbench implementation allowed | UI-007A–C receipts | 4-column shell, drafts v3, approval queue, rail modes, simulate send | `docs/ui/reviews/ui-007c-send-event-dry-run-receipt.md` | owner visual proof and north-star ratification pending | provider send in Tier 1 | partial | RISK-002 | owner spine ratification + UI-003E PASS |
...
| GATE-GMAIL-METADATA-001 | Gmail metadata/read-only adapter allowed | GMAIL-001B/C, GMAIL-002A hardening, GMAIL-002B gate docs + `tools/gmail/` adapter | privacy/scope plan, adapter CLI, token gitignore, wipe, blocked methods, read-only body gate | `docs/ui/reviews/gmail-002b-read-only-body-gate-receipt.md` | live proof token missing; peer review found hardening follow-ups | draft write, send, token in localStorage/repo, unreviewed snapshot expansion | partial (impl ready, proof/hardening open) | RISK-004, RISK-010 | hardening complete + GMAIL-002B-LIVE-PROOF PASS |
