...
| GATE-UI-VISUAL-001 | UI visual proof allowed | UI-004B–G and UI-005B–I receipts, UI-003E proof packet, UI-006 local commits | visual QA thresholds met, owner review ready | `docs/ui/reviews/ui-003e-owner-visual-proof-packet.md` | owner visual sign-off pending (post UI-006) | mark visual proof complete, PR ready-for-review | partial | RISK-002 | after owner UI-003E PASS |
