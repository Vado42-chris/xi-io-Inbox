...
| GATE-UI-VISUAL-001 | UI visual proof allowed | UI-011A–I, UI-012B–F, UI-003E proof packet, `npm run check:route` | product capability + automated route smoke; owner sign-off pending | `ui-012f-final-visual-readiness-gate-receipt.md`, `scripts/route-smoke.mjs` | owner UI-003E PASS | mark visual proof complete, PR ready-for-review | partial | RISK-002 | after owner UI-003E PASS |
