...
| GATE-DRAFT-WORKBENCH-001 | Draft workbench implementation allowed | UI-007A architecture docs, state reconciliation receipt | draft spine, send-event model, command rail modes documented | `docs/ui/reviews/ui-007a-draft-workbench-architecture-receipt.md` | UI-007A docs incomplete | UI-007B code without architecture | partial | RISK-002 | UI-007A pass; operator push UI-006 |
