...
| GATE-GMAIL-METADATA-001 | Gmail metadata-only adapter allowed | GMAIL-001B docs (scope, adapter, test, redaction policies) | privacy/scope plan, token storage boundary, wipe requirement, no-send gate, owner approval before primary metadata test | `docs/providers/gmail/gmail-001b-receipt.md` | GMAIL-001C implementation + owner approval pending | body export, draft write, send, token in localStorage/repo | partial (plan pass) | RISK-004, RISK-010 | GMAIL-001C adapter smoke |
