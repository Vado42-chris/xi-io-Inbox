...
| HYDRATE-RUNTIME-ENVELOPE-001 | platform/runtime envelope contract honored | partial | `docs/architecture/runtime-store-boundary-v1.md`, RUNTIME-001→002C receipts | Pass 4 runtime skeleton; distribution/offline boundaries | Pass 4 | RUNTIME spine complete; Pass 4 still blocked |
| HYDRATE-VISUAL-QA-001 | visual QA rubric exists | satisfied | `docs/ui/polish/12-visual-qa-rubric.md` | route receipts after polish | UI-003E owner proof | run UI-003E owner session |
...
| HYDRATE-FRESHNESS-001 | two-way framework freshness tracked | partial | `docs/architecture/xiio-framework-alignment.md`, `xi-io.net` `inbox-ui-consumer-freshness-note.md` | stable export path still open | `xi-io.net#239`, owner UI-003E | UI-007 backfeed posted; await export disposition |
| HYDRATE-ARCH004-001 | ARCH-004 platform/runtime status tracked | satisfied | `docs/architecture/arch-004-runtime-host-decision.md`, `docs/ui/reviews/arch-004-tauri-runtime-host-formal-decision-receipt.md` | downstream Pass 4 only | Pass 4 | maintain RUNTIME spine receipts |
