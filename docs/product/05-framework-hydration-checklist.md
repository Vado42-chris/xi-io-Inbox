...
| HYDRATE-WARGAME-001 | wargame scenario standard exists | satisfied | `docs/ui/polish/13-page-leveling-and-wargame-standard.md`, `docs/ui/polish/14-ui-wargame-scenario-matrix.md` | actual wargame receipt | none after PLAN-001A commit | run UI-004A.6 |
...
| HYDRATE-GATES-001 | build readiness gates exist | partial | `docs/product/04-build-readiness-gates.md` | update after each slice | active work | maintain gate states |
