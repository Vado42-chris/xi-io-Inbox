...
| COMP-BATCH-APPROVE-001 | Batch approve must show shared and per-draft risks; per-draft receipts required. | `docs/ui/ui-007-send-event-automation-model.md` | batch selection + risk summary review | pending | UI-007B | EVIDENCE-REQ-OPERABILITY-001 | REQ-EGRESS-001 | GATE-DRAFT-WORKBENCH-001 | authorization mapping pending |
