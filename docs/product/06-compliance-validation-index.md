...
| COMP-SEND-PREVIEW-001 | Send consequence preview must list downstream proposals before approve; dry-run language only in Tier 1. | `docs/ui/ui-007-send-event-automation-model.md` | approve flow smoke | partial (UI-007C) | UI-007D | EVIDENCE-REQ-OPERABILITY-001 | REQ-EGRESS-001, REQ-RECEIPTS-001 | GATE-DRAFT-WORKBENCH-001 | `ui-007c-send-event-dry-run-receipt.md` |
